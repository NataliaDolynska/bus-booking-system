...
from .views import index, login_user, logout_user, search_commute_suggestions, \
    suggest_arrival_stops, suggest_departure_stops, booking_page, user_bookings, cancel_booking, \
    admin_bookings, admin_cancel_booking, admin_booking_restrictions, add_booking_restriction, \
    delete_booking_restriction, admin_upload_gtfs, task_status, suggest_bus_lines
...
urlpatterns = [
    ...
    path('manager/delete-booking-restriction/<int:restriction_id>/', delete_booking_restriction,
         name='delete_booking_restriction'),
    # API endpoints
