...
from gtfs.models import Agency, Zone, Stop, RouteType, Route,  Direction, Block, Shape, Trip, PickupType, DropOffType, StopTime, Calendar, ExceptionType, CalendarDate, Fare, PaymentMethod, FareAttribute, FareRule, Frequency, Transfer


admin.site.register(Stop, admin.GISModelAdmin)
admin.site.register(Shape, admin.GISModelAdmin)
